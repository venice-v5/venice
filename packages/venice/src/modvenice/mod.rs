...
use crate::modvenice::{
    ...
    ai_vision::{
        AiVisionSensorObj, april_tag_family::AprilTagFamilyObj, color::AiVisionColorObj,
...
static mut venice_globals: Dict = Dict::new(const_map![
    ...
    qstr!(AprilTagFamily) => Obj::from_static(AprilTagFamilyObj::OBJ_TYPE),
    ...
    // time
    qstr!(monotonic_time) => monotonic_time_obj,
