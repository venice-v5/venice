use micropython_rs::{const_dict, obj::{Obj, ObjBase, ObjFullType, ObjTrait, TypeFlags}};
use vexide_devices::smart::ai_vision::AprilTagFamily;

use crate::qstrgen::qstr;


static APRIL_TAG_FAMILY_OBJ_TYPE: ObjFullType = ObjFullType::new(TypeFlags::empty(), qstr!(AprilTagFamily))
